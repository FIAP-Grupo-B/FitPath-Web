...
import fitpathfitpath from 'assets/verde-branco.png'
    ...
    <>
      <div className='flex flex-col'>
        ...
        <Container sx={{display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', paddingInline: {xs: '2.5rem', md: '1rem'}}}>
          <Box sx={{width: {xs: '15rem', md: '20rem'}, height: '15rem'}}>
            <picture>
                <img src={fitpathfitpath} className='top-0 left-1/2 -translate-y-1/2'  alt='Fitpath' />
            </picture>
          </Box>
